...
@section("page-name","Post Category");
...
<div class="content container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <a class="btn btn-info btn-sm" href="#cat_modal" data-toggle="modal">Add New Category</a><br><br>

            @include('validate')

            <div class="card">
                <div class="card-header">
                    <h4 style="display:inline;margin-right:50px" class="card-title">Category Data</h4>
