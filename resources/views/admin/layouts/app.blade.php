...
<head>
		...
		<script src="https://kit.fontawesome.com/d6ad57530e.js" crossorigin="anonymous"></script>
    ...
    <body>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							...
							<img src="admin/assets/img/avatar-1.png" class="rounded-circle" width="35">
							@elseif(Auth::user() -> photo == NULL && Auth::user() -> gender == "Female")
							<img src="admin/assets/img/avatar-2.png" class="rounded-circle" width="35">
							@elseif(Auth::user() -> photo == NULL)
							<img src="admin/assets/img/avatar-3.png" class="rounded-circle" width="35">
							@elseif(Auth::user() -> photo != NULL)
							<img src="{{ url("") }}/media/users/{{ Auth::user() -> photo }}" class="rounded-circle" width="35" height="35px">
							@endif
							</span>
						</a>
		...
		<script src="admin/assets/js/fontawesome.min.js"></script>
