    ...
    <header id="topnav">
        <div class="container">
          ...
          <div class="logo">
            <a href="index-2.html">
              <img src="comet/images/logo_light.png" alt="" class="logo-light">
              <img src="comet/images/logo_dark.png" alt="" class="logo-dark">
            </a>
          </div>
          <!-- End Logo container-->
                  ...
                  <ul class="nav product-list">
                    <li>
                      <div class="product-thumbnail">
                        <img src="comet/images/shop/2.jpg" alt="">
                      </div>
                    ...
                    <li>
                      <div class="product-thumbnail">
                        <img src="comet/images/shop/5.jpg" alt="">
                      </div>
                      <div class="product-summary">
                ...
                <ul class="submenu">
                  ...
                  <li class="has-submenu">
                    ...
                    <ul class="submenu">
                      ...
                      <li>
                        <a href="{{ route("blog.show") }}">Right Sidebar</a>
                      </li>
                      <li>
